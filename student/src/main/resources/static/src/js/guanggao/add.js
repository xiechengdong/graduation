var fromAction = {
    ...
    save: function () {
        ...
        mini.ajax({
            url:  'http://25x535820c.qicp.vip:39011/guanggao/manageModify',
            dataType: "json",
    ...
    goBack: function () {
        window.location.href = "/pages/guanggao/list.html";
    },
};
//初始化函数
$(function () {
...
function getByUserID(Id) {
    ...
    wdutil.ajax.post({
        url: 'http://25x535820c.qicp.vip:39011/guanggao/findById/' + Id,
