var listAction = {
    grid: null,//结果grid
    getStuUrl: "http://25x535820c.qicp.vip:39011/systemInfo/findall",
    ...
    iscanceled: function(id){
        console.log(id);
        wdutil.ajax.post({
            url: 'http://25x535820c.qicp.vip:39011/systemInfo/deleteById/'+id,
            //data: {userId: userId},
    ...
    edit: function (userId) {
        window.location.href = "/pages/system/add.html?&pid=" + userId;
    },

    // 添加界面
    add: function () {
        window.location.href = "/pages/system/add1.html";
    },
