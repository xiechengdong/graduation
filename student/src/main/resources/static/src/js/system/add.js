var fromAction = {
    ...
    save: function () {
        ...
        mini.ajax({
            url:  'http://25x535820c.qicp.vip:39011/systemInfo/manageModify',
            dataType: "json",
...
$(function () {
    mini.parse();
    var  bookId = getUrlParam("pid");
    getByUserID(bookId);
    fromAction.init();

});

function getByUserID(bookId) {
    var temform = new mini.Form("#formPanel");
    wdutil.ajax.post({
        url: 'http://25x535820c.qicp.vip:39011/systemInfo/findBySysId/' + bookId,
