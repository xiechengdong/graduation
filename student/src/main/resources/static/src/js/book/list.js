var listAction = {
    grid: null,//结果grid
    getStuUrl: "http://25x535820c.qicp.vip:39011/book/findall",
    ...
    iscanceled: function(id){
        console.log(id);
        wdutil.ajax.post({
            url: 'http://25x535820c.qicp.vip:39011/book/deleteById/'+id,
            //data: {userId: userId},
    ...
    edit: function (userId) {
        window.location.href = "/pages/book/add.html?&pid=" + userId;
    },
