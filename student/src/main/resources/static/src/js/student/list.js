var listAction = {
    grid: null,//结果grid
    getStuUrl: "http://25x535820c.qicp.vip:39011/stu/findAllStu",
    ...
    iscanceled: function(id){
        console.log(id);
        wdutil.ajax.post({
            url: 'http://25x535820c.qicp.vip:39011/stu/delByStuId/'+id,
            //data: {userId: userId},
    ...
    resetpsw: function(id){
        wdutil.ajax.post({
            url: 'http://25x535820c.qicp.vip:39011/stu/RestePassword/'+id,
            //data: {userId: userId},
            success: function (text) {
                wdutil.win.alert("操作成功");
                //listAction.grid.reload();
    ...
    edit: function (userId) {
        window.location.href = "/pages/student/add.html?&pid=" + userId;
    },
